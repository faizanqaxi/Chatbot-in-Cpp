...
int main()
{
	...
	string questionAnswersFilePath = "./questionAnswers.txt";

	string lemmatizationMappingFilePath = "./lemmatizationData.txt";

	cout << endl
		 << "WAIT ! Loading ChatBot.." << endl;

	loadStemmingWords(lemmatizationMappingFilePath, '\t');
	loadQuestionsData(questionAnswersFilePath, '\t');

	cout << endl
		 << "ChatBot Loaded succesfully !!" << endl;

	cout << endl
		 << "Total Questions in hash table: " << h1.getTotalElements() << endl;
	cout << endl
		 << "Total Words in 2nd hash table: " << mappedStemming.getTotalElements() << endl;
	...
	cout << endl
		 << "Hello Human ! How may I help you?" << endl;
	...
	while (askedQuestion != "0")
	{
		...
		{
			cout << endl
				 << "I'm sorry i do not know the answer to this question" << endl;
			...
			cout << endl
				 << "Thank You! I'll remember it next time :)" << endl;
		}
		else
		{
			cout << endl
				 << h1.getAns(filteredQuestion) << endl;
		}
